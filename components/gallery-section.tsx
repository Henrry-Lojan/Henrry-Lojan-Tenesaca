...
const galleryItems: GalleryItem[] = [
    ...
    { id: 50, src: "/images/gallery/video-puente-condor-1.mp4", type: "video", category: "Visitas de Obras", title: "Video – Puente Río Cóndor (1)", description: "Registro en video de actividades de campo y control topográfico en el Puente Río Cóndor, Francisco de Orellana." },
    { id: 51, src: "/images/gallery/video-puente-condor-2.mp4", type: "video", category: "Visitas de Obras", title: "Video – Puente Río Cóndor (2)", description: "Registro de actividades de inspección y replanteo en el Puente Río Cóndor." },
    { id: 52, src: "/images/gallery/video-visita-obra-1.mp4", type: "video", category: "Visitas de Obras", title: "Video – Visita de Obra (1)", description: "Registro de visita de obra civil, supervisión de elementos estructurales y control de calidad." },
    { id: 53, src: "/images/gallery/video-visita-obra-2.mp4", type: "video", category: "Visitas de Obras", title: "Video – Visita de Obra (2)", description: "Inspección de avance de obra y revisión de especificaciones técnicas en campo." },
    { id: 54, src: "/images/gallery/video-visita-obra-3.mp4", type: "video", category: "Visitas de Obras", title: "Video – Visita de Obra (3)", description: "Documentación visual de procesos constructivos y supervisión técnica." },
    { id: 55, src: "/images/gallery/video-visita-obra-4.mp4", type: "video", category: "Visitas de Obras", title: "Video – Control de Obra Civil (1)", description: "Control de elementos estructurales, verificación de armados y concreto." },
    { id: 56, src: "/images/gallery/video-visita-obra-5.mp4", type: "video", category: "Visitas de Obras", title: "Video – Control de Obra Civil (2)", description: "Revisión de procesos constructivos, mediciones y control de avance." },
    { id: 57, src: "/images/gallery/video-visita-obra-6.mp4", type: "video", category: "Visitas de Obras", title: "Video – Vista Panorámica de Obra", description: "Vista panorámica de la obra con registro completo del estado de avance." },
    { id: 58, src: "/images/gallery/video-visita-obra-7.mp4", type: "video", category: "Visitas de Obras", title: "Video – Registro Final de Obra", description: "Documentación final de obra: verificación de terminados, detalles y cierre." },
]
