...
const experiences = [
    ...
    {
        id: 3,
        role: "Fiscalizador de Obras",
        company: "Municipio de Loja / Gobierno Provincial de Loja",
        period: "2018 – 2019",
        location: "Loja, Ecuador",
        type: "Contrato Público",
        icon: Building2,
        color: "primary",
        current: false,
        highlights: [
            "Supervisión técnica y administrativa de obras de infraestructura pública",
            "Control de calidad en obras viales y de saneamiento",
            "Elaboración de informes técnicos de avance y liquidación de contratos",
            "Coordinación con contratistas y comunidades beneficiarias",
        ],
        technologies: ["AutoCAD", "Ms Project", "Obras 6.0", "SERCOP"],
    },
    {
        id: 4,
